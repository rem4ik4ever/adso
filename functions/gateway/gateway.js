...
exports.handler = async function(event, context) {
  const schema1 = await getSchema("hello"); // other Netlify functions which are graphql lambdas
  // const schema2 = await getSchema("fauna"); // other Netlify functions which are graphql lambdas
